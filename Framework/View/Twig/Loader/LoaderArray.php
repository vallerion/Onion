 ...
 */
class LoaderArray implements LoaderInterface, ExistsLoaderInterface, SourceContextLoaderInterface
{
    ...
    public function getSource($name)
    {
        ...
        if (!isset($this->templates[$name])) {
            throw new ErrorLoader(sprintf('Template "%s" is not defined.', $name));
        }
