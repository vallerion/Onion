...
{
    public function __construct($capture, NodeInterface $names, NodeInterface $values, $lineno, $tag = null)
    {
        ...
        if ($this->getAttribute('capture')) {
            ...
            if ($values instanceof NodeText) {
                $this->setNode('values', new NodeExpressionConstant($values->getAttribute('data'), $values->getTemplateLine()));
