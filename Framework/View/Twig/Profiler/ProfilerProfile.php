...
namespace Framework\View\Twig\Profiler;
 ...
 */
class ProfilerProfile implements IteratorAggregate, Serializable
{
    const ROOT = 'ROOT';
    const BLOCK = 'block';
    ...
    public function addProfile(ProfilerProfile $profile)
    {
