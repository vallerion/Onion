...
use Exception;
use Framework\View\Twig\TemplateInterface;
 ...
 * instead, which returns an instance of TemplateWrapper.
 *
...
abstract class Template implements TemplateInterface
{
     ...
     * @param array $context
     *
     * @return TemplateInterface|false The parent template or false if there is no parent
     *
     * @internal
     */
    ...
    public function displayParentBlock($name, array $context, array $blocks = array())
    {
        ...
        if (isset($this->traits[$name])) {
            ...
            throw new ErrorRuntime(sprintf('The template has no parent and no traits defining the "%s" block.', $name), -1, $this->getTemplateName());
        }
    }
    ...
    public function displayBlock($name, array $context, array $blocks = array(), $useBlocks = true)
    {
        ...
        if (null !== $template) {
            ...
            try {
                ...
                throw new ErrorRuntime(sprintf('An exception has been thrown during the rendering of a template ("%s").', $e->getMessage()), -1, $template->getTemplateName(), $e);
            }
        } elseif (false !== $parent = $this->getParent($context)) {
    ...
    protected function displayWithErrorHandling(array $context, array $blocks = array())
    {
        try {
            ...
            throw new ErrorRuntime(sprintf('An exception has been thrown during the rendering of a template ("%s").', $e->getMessage()), -1, $this->getTemplateName(), $e);
        }
    }
     ...
     *
     * @throws ErrorRuntime if the variable does not exist and Twig is running in strict mode
     *
     * @internal
     */
    final protected function getContext($context, $item, $ignoreStrictCheck = false)
    {
        if (!array_key_exists($item, $context)) {
            ...
            throw new ErrorRuntime(sprintf('Variable "%s" does not exist.', $item), -1, $this->getTemplateName());
        }
     ...
     *
     * @throws ErrorRuntime if the attribute does not exist and Twig is running in strict mode and $isDefinedTest is false
     *
     * @internal
     */
    protected function getAttribute($object, $item, array $arguments = array(), $type = self::ANY_CALL, $isDefinedTest = false, $ignoreStrictCheck = false)
    {
        ...
        if (self::METHOD_CALL !== $type) {
            ...
            if (self::ARRAY_CALL === $type || !is_object($object)) {
                ...
                throw new ErrorRuntime($message, -1, $this->getTemplateName());
            }
        }
        ...
        // object property
        if (self::METHOD_CALL !== $type && !$object instanceof self) { // Template does not have public properties, and we don't want to allow access to internal ones
            if (isset($object->$item) || array_key_exists((string) $item, $object)) {
                if ($isDefinedTest) {
                    return true;
                }

                if ($this->env->hasExtension('ExtensionSandbox')) {
                    $this->env->getExtension('ExtensionSandbox')->checkPropertyAllowed($object, $item);
                }
        ...
        if (isset(self::$cache[$class][$item])) {
            ...
            throw new ErrorRuntime(sprintf('Neither the property "%1$s" nor one of the methods "%1$s()", "get%1$s()"/"is%1$s()" or "__call()" exist and have public access in class "%2$s".', $item, $class), -1, $this->getTemplateName());
        }
        ...
        if ($this->env->hasExtension('ExtensionSandbox')) {
            $this->env->getExtension('ExtensionSandbox')->checkMethodAllowed($object, $method);
        }
